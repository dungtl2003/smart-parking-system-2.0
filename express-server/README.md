...
-   if you change some relations in [schema.prisma](./src/prisma/schema.prisma) file, you must regenerate prisma client

```shell
npm run db-generate
```

-   you can check the invalid code with this command (optional):
